...
const getBooksinyuear= async function (req, res) {
...
const getParticularBooks= async function (req, res) {
    let condition= req.body
     let savedData= await BookModel.find(condition)
    res.send({msg: savedData})
}
...
const getXINRBooks= async function (req, res) {
    ...
    let allBooks= await BookModel.find({   "prices.indianPrice"  :{$in:["100NRI","200NRI","500NRI"]}}       )
...
module.exports.getBooksinyuear = getBooksinyuear
